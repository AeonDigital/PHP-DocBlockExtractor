...
use AeonDigital\DocBlockExtractor\OutputExtractor\XML as XML;
...
class XMLTests extends TestCase
{
    ...
    public function test_method_extract_toSingleFile()
    {
        ...
        $expectedDir = $this->pathToOutputDocs . "/XMLSingle/expected";
        $resultDir = $this->pathToOutputDocs . "/XMLSingle/result";
